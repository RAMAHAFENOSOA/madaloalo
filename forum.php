...
<div class="container-fluid">
    <div class="row flex-nowrap" >
        <div class="col-auto col-md-3 col-xl-2 px-sm-2 px-0" style="background-color:#178ca4;position:fixed;z-index:3">
                ...
                <li class="nav-item">
                    ...
                    <li>
                        <a href="#" class="nav-link px-0 align-middle text-white">
                            <i class="bi bi-chat-left-text-fill"></i> <span class="ms-1 d-none d-sm-inline text-white">boîte à questions</span> </a>
                    </li>
                    <li>
                        <a href="#" class="nav-link px-0 align-middle text-white">
                        <i class="bi bi-chat-left-dots-fill"></i> <span class="ms-1 d-none d-sm-inline text-white">chat</span> </a>
                    </li>
                </ul>
                <hr>
        ...
        <div class="col py-3" style="padding-left:25%;" >
            <!-- message -->
                                   ...
                                   <div class="card mb-4">
                                       <div class="card-header">
                                           <div class="media flex-wrap w-100 align-items-center" style="display:flex;"> 
                                               <img src="https://i.imgur.com/iNmBizf.jpg" class="ui-w-40 rounded-circle" alt="">
                                               <div class="media-body ml-3" style="margin-left:15px"> 
                                       ...
                                       <div class="card-footer d-flex flex-wrap justify-content-between align-items-center px-0 pt-0 pb-3" >
                                           <div></div>
                                           <div class="px-4 pt-3" > <button type="button" class="btn btn-primary" style="position:relative"><i class="ion ion-md-create"></i>&nbsp;Reply</button> </div>
                                       </div>
                                    </div>
                                </div>
