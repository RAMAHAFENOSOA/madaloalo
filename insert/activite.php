...
<a href="hotel.php">hotel</a>
    ...
    <h1 class="text-center">Modification activite </h1>
    <div class="container">
        <form action="insert_act.php" method="post" enctype="multipart/form-data">
        <div class="form-group">
            <label for="user" class="form-label">Nom activite</label>
        ...
        <div class="form-group">
            <label for="pass" class="form-label">prix activite</label>
            <input type="text" name="prix"  class="form-control">
        </div>   
        
        <div class="form-group">
            <label for="pass" class="form-label">Image activite</label>
