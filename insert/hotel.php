...
<a href="region.php">region</a>
    ...
    <h1 class="text-center">Ajouter Hotel </h1>
    <div class="container">
        <form action="insert_hotel.php" method="post"  enctype="multipart/form-data">
        <div class="form-group">
            <label for="user" class="form-label">Nom hotel</label>
            <input type="text" name="nom"  class="form-control">
        </div>

        <div class="form-group">
            <label for="pass" class="form-label">Selectionnez le region</label>
            <select type="text" name="region"  class="form-select">
        ...
        <div class="form-group">
            <label for="text" class="form-label">Desription</label>
            <input type="text" name="descr"  class="form-control">
        </div>

        <div class="form-group">
            <label for="pass" class="form-label">Adresse</label>
            <input type="text" name="adresslieu"  class="form-control">
        </div>  

        <div class="form-group">
            <label for="pass" class="form-label">Prix séjour</label>
