      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-md-6 d-flex align-items-stretch" data-aos="fade-up">
            <div class="card">
              <div class="card-img">
                <img src="assets/img/madama.jpg" alt="...">
              </div>
              <div class="card-body">
                <h5 class="card-title"><a href="#">Nos missions</a></h5>
                <p class="card-text">Les voyageurs d'aujourd'hui préfèrent effectuer leurs réservations en ligne pour gagner du temps bénéficier de la commodité offerte par Internet . Alors notre site consiste à aider les voyageurs à prendre des décisions éclairées et à planifier leurs vacances.</p>
          ...
          <div class="col-md-6 d-flex align-items-stretch" data-aos="fade-up">
            <div class="card">
              <div class="card-img">
                <img src="assets/img/rajako copie1.jpg" alt="...">
              </div>
              <div class="card-body">
                <h5 class="card-title"><a href="#">Nos plans</a></h5>
                <p class="card-text">Un site de e-tourisme permet aux utilisateurs de rechercher, comparer et réserver des vols, des hébergements, des activités touristiques, des visites guidées, etc., en quelques clics, ce qui facilite le processus de réservation et augmente vos chances de conclure des ventes.</p>
